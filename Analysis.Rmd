...
# Example clustering on temperature variables
temp_matrix <- as.matrix(data %>% select(T1, T2, T3, T4, T5, T6, T7, T8, T9))
temp_dist <- dist(temp_matrix, method="DTW")
temp_cluster <- hclust(temp_dist)
plot(temp_cluster, main="Hierarchical Clustering of Temperature Variables")
